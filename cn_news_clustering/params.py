...
class Globals:
    ...
    model_path = "./model_data/refined_cn_news_clustering.joblib"
    db_path = "./model_data/pages_data.json"
    invalid_sites_path = "./model_data/invalid_sites.json"

    ### Emojis ###
    popcorn = emoji.emojize(':popcorn:')
    heart = emoji.emojize(':red_heart:')
    fire = emoji.emojize(':fire:')
    redq = emoji.emojize(':red_question_mark:')
    skull = emoji.emojize(':skull_and_crossbones:')
    search = emoji.emojize(':magnifying_glass_tilted_right:')
    check = emoji.emojize(':check_mark_button:')
    neutral = emoji.emojize(':neutral_face:')
    raw = emoji.emojize(':cut_of_meat:')
    cry = emoji.emojize(':loudly_crying_face:')
    cat_smile = emoji.emojize(':cat_with_wry_smile:')
    floppy = emoji.emojize(':floppy_disk:')
    web = emoji.emojize(':spider_web:')
